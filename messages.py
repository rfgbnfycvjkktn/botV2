...
def help_menu():
    return '<b>Параметры, используемые при поиске:</b>' \
           ...
           + '\n' + u'\U00000033' + u'\U000020E3' + ' Дюрация (количество месяцев) — эффективный срок до погашения ' \
                                                    ...
                                                    'погашения облигации. ' \
           + '\n' + u'\U00000034' + u'\U000020E3' + ' Объем торгов (количество штук). На данный момент ' \
           ...
           + '\n\n' "При возникновении вопросов обращайтесь https://t.me/Anton4e"
...
def search_menu():
    return '<b>Поиск облигаций.</b>' \
           + '\n\n' + u'\U00002757 В <b>базовом</b> варианте поиск осуществляется по ' \
                                              ...
                                              u'последние 2 недели. Дюрация 8-24 месяцев. ' \
